...
(function () {
    ...
    const samus = makeSprite('/assets/images/games/sprites/SamusRunningR.gif', SAMUS_BOTTOM);
    const ball  = makeSprite('/assets/images/games/sprites/SamusBall.gif', SAMUS_BOTTOM);
